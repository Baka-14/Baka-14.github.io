...
A piece of work where post finishing it you repeatedly look back at it and are in a state of awe wondering what the hell did I just make. A piece of work you want to share with rest of the world because you want to show them what you made. 
...
Art & Humanities is what keep us going. Art gives one hope, gives one inspiraion, gives one dreams to chase. Everything in this world is art. Art can be in an insane company someone builds. Art can be a block of code someone wrote that is changing the world (Example: [Linux kernel](https://github.com/torvalds/linux) ). Art is present everywhere around us. We just need to be open enough to understand it and see it. 
...
Its going to be hard to create a masterpiece. You are going to fail, but to create something great it takes time right ? it takes effort ? it takes passion ?. 
